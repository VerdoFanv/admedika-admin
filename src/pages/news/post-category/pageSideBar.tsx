					...
					<div className="admin-sidebar-body">
						<div className="form-fieldset">
							<div className="form-fieldset-body">
								<div className="row">
									<FormCheck setForm={setForm} type="checkbox" name="post_cat_status" label="Active" />
								</div>
								<div className="row">
									<FormInput setForm={setForm} name="pcl_seo_title.id" label="Meta title (ID)" />
								</div>
								<div className="row">
									<FormInput setForm={setForm} name="pl_seo_title.en" label="Meta title (EN)" />
								</div>
								<div className="row">
									<FormInput setForm={setForm} name="pcl_seo_keywords.id" label="Meta keyword (ID)" />
								</div>
								<div className="row">
									<FormInput setForm={setForm} name="pcl_seo_keywords.en" label="Meta keyword (EN)" />
								</div>
								<div className="row">
									<FormTextarea setForm={setForm} name="pcl_seo_descriptions.id" label="Meta description (ID)" />
								</div>
								<div className="row">
									<FormTextarea setForm={setForm} name="pcl_seo_descriptions.en" label="Meta description (EN)" />
								</div>
							</div>
						</div>
					</div>
