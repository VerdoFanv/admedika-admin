										...
										content={[
											{
												item: (
													<div className="row">
														<FormInput setForm={setForm} name="meta.text.header_text.en" label="Header text (EN)" />
													</div>
												)
											},
											{
												item: (
													<div className="row">
														<FormInput setForm={setForm} name="meta.text.header_text.id" label="Header text (ID)" />
													</div>
												)
											}
										]}
...
NewsFaq.getLayout = function getLayout(page) {
	return (
		<Dashboard>
			{page}
		</Dashboard>
