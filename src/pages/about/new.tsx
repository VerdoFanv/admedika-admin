...
export default function AboutInformationNew() {
	...
	async function onSubmit(data) {
		...
		try {
			await postData(`/page/create`, {
				...data,
				page_type: `about-general`,
				page_parent_id: pageId?.data?.page_id[`about`],
...
AboutInformationNew.getLayout = function getLayout(page) {
	return (
		<Dashboard>
			{page}
		</Dashboard>
